...
import Galaxy from '@/components/features/animated-grid-bg/index';
  ...
  return (
    <>
      ...
      <main className="dark relative flex min-h-full w-full flex-col overflow-hidden">
        ...
        <div className="my-2 mt-8 flex min-h-[700px] w-full flex-col items-center justify-center p-4 min-[560px]:p-8">
          <div className="w-full max-w-xl">
            <div className="mb-10 flex flex-col items-center space-y-2 text-center sm:space-y-1">
              {/* Logo and Title */}
              <div className="mb-4 flex flex-col items-center gap-2 sm:gap-2">
                <h1 className="text-foreground text-2xl tracking-tight sm:text-3xl">
                  Build Together{' '}
                  <span className="bg-gradient-to-r from-[#fb568a] to-[#e456fb] bg-clip-text text-3xl text-transparent">
                    with <span className="text-white/30">SyncCode</span>{' '}
                  </span>
                </h1>
              </div>

              {/* Description */}
              <p className="text-center font-mono text-xs text-white/90 sm:text-xs">
        ...
        {/* Bottom buttons */}
        <div className="dark fixed bottom-2.5 right-4 flex scale-90 items-center gap-x-4">
          <Status />
          <LatencyTestButton />
        </div>
      </main>
